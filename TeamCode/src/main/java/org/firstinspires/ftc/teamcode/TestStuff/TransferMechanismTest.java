    ...
    public void loop() {
        ...
        if (leftBumperPressed && !prevLeftBumper) {     // rising edge
            ...
            switch((int)outtakeCounter) {
                case 0: wheel.rotateToAngle(310, 0.2); break;
                case 1: wheel.rotateToAngle(90, 0.2); break;
                case 2: wheel.rotateToAngle(170, 0.2); break;
            }
        ...
        if (rightBumperPressed && !prevRightBumper) {   // rising edge
            ...
            switch((int)intakeCounter) {
                case 0: wheel.rotateToAngle(60, 0.2); break;
                case 1: wheel.rotateToAngle(170, 0.2); break;
                case 2: wheel.rotateToAngle(280, 0.2); break;
            }
